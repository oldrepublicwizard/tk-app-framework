...
try:
    ...
    def RobustLogger(*a, **k):
        return logging.getLogger('tk_app_framework')
from tk_app_framework._log import PatchLogger  #  LogType, PatchLogger
from tk_app_framework._misc import ensure_directory_exists

if TYPE_CHECKING:
    from collections.abc import Callable
    from pathlib import Path

    from tk_app_framework._log import PatchLogger  #  PatchLog
